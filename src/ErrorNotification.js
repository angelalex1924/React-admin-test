...
import './ErrorNotification.css'; // Εάν το αρχείο style.css βρίσκεται στον ίδιο φάκελο με αυτό το αρχείο
...
const ErrorNotification = () => {
  ...
  return (
    <div className="Error-notification">
      <div className="Error-notification__body">
      ...
      <div className="Error-notification__progress"></div>
    </div>
  );
};
